...
import com.hnhy.socketdemokotlin.adapter.MsgAdapter
import com.hnhy.socketdemokotlin.bean.Message
import com.hnhy.socketdemokotlin.client.ClientCallback
import com.hnhy.socketdemokotlin.client.SocketClient
import com.hnhy.socketdemokotlin.databinding.ActivityBaseSocketBinding
import com.hnhy.socketdemokotlin.databinding.DialogEmojiBinding
import com.hnhy.socketdemokotlin.server.ServerCallback
import com.hnhy.socketdemokotlin.server.SocketServer
import com.hnhy.socketdemokotlin.ui.BaseActivity
import com.hnhy.socketdemokotlin.ui.EmojiCallback
...
/*        etMsg.addTextChangedListener {
     ...
     * 接收客户端消息
     */
    override fun receiverClientMsg(ipAddress: String, msg: String) = updateList(false, msg)

    /**
     * 接收服务端消息
     */
    override fun receiverServerMsg(ipAddress: String, msg: String) = updateList(false, msg)
